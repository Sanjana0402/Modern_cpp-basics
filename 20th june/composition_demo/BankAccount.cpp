...
BankAccount::BankAccount(long number, std::string name, float balance, BankAccountType accountType, DebitCard* card):m_accountBalance{balance},m_accountHolderName{name},m_accountNumber{number},m_accountType{accountType},m_attached_card{card}
{
